...
export const users = pgTable('users', {
    ...
    user_uuid: uuid('user_uuid').notNull().default(sql`extensions.uuid_generate_v4()`),
...
export const allBlogs = pgTable('all_blogs', {
    id: serial('id').primaryKey(),
    blog_uuid: uuid('blog_uuid').notNull().default(sql`extensions.uuid_generate_v4()`),
...
export const blogPosts = pgTable('blog_posts', {
    id: serial('id').primaryKey(),
    post_uuid: uuid('post_uuid').notNull().default(sql`extensions.uuid_generate_v4()`),
